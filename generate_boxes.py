...
if __name__ == '__main__':
    ...
    parser.add_argument('-p','--prompt', help='text prompt specifying objects to detect', default="traffic light.")
    parser.add_argument('-t','--text-threshold', help='threshold for the text prompt', default="0.3")
    parser.add_argument('-b','--box-threshold', help='threshold for the box ', default="0.25")
